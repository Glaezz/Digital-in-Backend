...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We accept requests to Verify Email your Digital-in account. Click the button below to continue verify process:</p>

            <center>
                <a href="{{$data["verify_url"]}}" class="button">Verify Email</a>
            </center>
